  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="rounded-3xl border border-white/[0.12] bg-gradient-to-b from-[#0e172a]/90 to-[#090d16] p-8 sm:p-12 text-center relative overflow-hidden shadow-2xl backdrop-blur-md">
          {/* Ambient Glow */}
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <div className="flex items-center gap-2 rounded-xl bg-white/[0.05] border border-white/[0.12] px-4 py-3 text-sm font-medium text-white shadow-inner max-w-full">
                <Mail className="h-4 w-4 text-cyan-400 shrink-0" />
                <span className="truncate">{personalInfo.email}</span>
                <button
                  onClick={handleCopyEmail}
                  className="ml-2 inline-flex items-center gap-1 rounded-lg bg-white/10 hover:bg-white/20 px-2.5 py-1 text-xs font-semibold text-white transition-colors"
            ...
            {/* Social & Resume Links */}
            <div className="mt-8 pt-8 border-t border-white/[0.08] flex flex-wrap items-center justify-center gap-4">
              <a
